...
INSERT INTO MEMBER
VALUES ('admin', '$2a$10$BD.4Ik86tpfIc8sdj70sGOkdaZXTjTaAXurZqCW0E/xCHF0nmcYBa', '관리자', 'admin@kh.or.kr', 'F', 30, '010-1111-2222', '서울시 강남구 역삼동', '20190101', '20190101', DEFAULT);

INSERT INTO MEMBER
VALUES ('user01', '$2a$10$j0Mp0DR9m2pi7Hf8wCArsu/HEzdlYBeLbsg03cllOKKuPYmLJvKee', '홍길동', 'user01@kh.or.kr', 'M', 25, '010-3333-4444', '서울시 마포구 공덕동', '20190201', '20190201', DEFAULT);

INSERT INTO MEMBER
VALUES ('user02', '$2a$10$nhKEdpo.1lu/mRUnxQGygeJ7kqsbSe74dtK58NMA5OAvEDFaQRe0m', '김말똥', 'user02@kh.or.kr', 'F', 23, '010-5555-6666', '서울시 영등포구 양평동', '20190301', '20190301', DEFAULT);
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '열한번째 게시글', 'user01', 'jstl 을 쓰면 JSP 에서 자바 구문을 없앨 수 있어요.', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '열네번째 게시글', 'user01', '스프링은 자바로 웹사이트 구현을 더 수월하게 할 수 있도록 도와주는 프레임워크에요!', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '열다섯번째 게시글', 'user02', '리액트는 SPA (Single Page Application) 구현을 도와주는 자바스크립트 라이브러리입니다~~', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '열여섯번째 게시글', 'user01', 'Rest API 는 프론트와 백엔드 사이의 통신을 정의하는 일종의 규칙', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO BOARD
VALUES (SEQ_BNO.NEXTVAL, '열일곱번째 게시글', 'admin', '열심히 공부하세요. 화이팅.', NULL, NULL, DEFAULT, DEFAULT, DEFAULT);
